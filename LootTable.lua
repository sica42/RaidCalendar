...
M.loot_table = {
	...
	[ 101 ] = {
		...
		[ "raidItems" ] = { {
			...
			[ "id" ] = 7827,
			[ "icon" ] = "inv_scroll_06",
			[ "name" ] = "Schematic: Giga-Charged Arcane Reflector",
			[ "quality" ] = 4,
			[ "itemId" ] = 58401,
			[ "raidBosses" ] = { 639, 640, 641, 642, 643, 644 }
		} }
